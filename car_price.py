...
def model_pred(encoded_fuel_type,encoded_transmission_type, engine, seats):# Recent Added
...
if st.button("Predict Price"):
    ...
    price = model_pred(encoded_fuel_type,encoded_transmission_type, engine, seats)#Recent Added
